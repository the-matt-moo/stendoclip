...
### Changed
- About window and README now document the config path (`%AppData%\Stendoclip\config.json`)

## [1.0.8] - 01-09-2026

### Added
- About window now shows the current keybindings, and updates when config reloads
